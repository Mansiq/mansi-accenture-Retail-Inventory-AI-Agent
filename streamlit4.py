...
st.markdown("""
    <style>
        ...
        .block-container {
            padding-top: 0px !important;    /* Remove empty space at top */
...
with left_col:
    st.markdown("""
    <h1 style='font-size: 4px;'>Accenture Research Agent</h1>
    """, unsafe_allow_html=True)
    ...
    chat_container = st.container(height=370, border=True)
